...
export function BorrowingOptimizerView({
	...
	const sliderTrackRef = useRef<HTMLButtonElement>(null);
					...
					{objectiveOmegas.map((omega, i) => {
						...
						return (
							<button
								...
								className={`absolute -translate-x-1/2 whitespace-nowrap text-[10px] transition-colors ${
									active
					...
					>
                      ...
                      id="treshold"
											...
											onBlur={() => {
												...
												setBufferInput(
													priceData.length > 0 ? Math.abs(buffer).toFixed(2) : "",
												);
											}}
											onChange={(e) => {
