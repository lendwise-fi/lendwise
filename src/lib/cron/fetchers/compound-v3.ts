import { COMPOUND_CONFIG } from '@/lib/adapters/compound/config'
import { MarketsApyQuery } from '@/lib/adapters/compound/v3/onchain/generated/graphql'
import { MARKETS_APY } from '@/lib/adapters/compound/v3/onchain/queries'
